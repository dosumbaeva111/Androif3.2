...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    protected class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(Post post) {
            ...
            username.put(1, "0");
            username.put(2, "Мамедов Руслан");
            username.put(3, "Бейшенбаев Бекбол");
            username.put(4, "Эргешбай уулу Акжол");
            username.put(5, "Эдельвейс Пономарев");
            username.put(6, "Алимбекова Арууке");
            username.put(7, "Даниель Мубаракамир");
            username.put(8, "Нурсултан Турдубеков");
            username.put(9, "Данияр Жээнмырзаев");
            username.put(10, "Перизат Досумбаева");
